...
class _AnalyticsScreenState extends State<AnalyticsScreen>
      ...
      return Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Statistical data will appear after events are created',
  ...
  Widget _buildEventTypeChart() {
    // Simulasi data kosong - nanti bisa diganti dengan data real
    final hasData = false;
            ...
            child: hasData
                    ...
                    children: [
                      ...
                      Expanded(
                        ...
                        child: Column(
                          ...
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            // Legend items akan ditampilkan di sini ketika ada data
                          ],
                        ),
                      ),
                    ],
                ...
                : Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 8),
                      Text(
                        'Event type distribution will appear after events are created',
                        textAlign: TextAlign.center,
                        style: TextStyle(
                          fontSize: 14,
                          color: Colors.grey[500],
          ...
          if (activities.isEmpty)
            Column(
              children: [
                ...
                const SizedBox(height: 8),
                Text(
                  'Recent activity will appear after events take place',
                  textAlign: TextAlign.center,
                  style: TextStyle(
                    fontSize: 14,
                    color: Colors.grey[500],
      ...
      return Container(
        ...
        child: Column(
          children: [
            ...
            const SizedBox(height: 8),
            Text(
              'Event list will appear after you create your first event',
              textAlign: TextAlign.center,
              style: TextStyle(
                fontSize: 14,
                color: Colors.grey[500],
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    LinearProgressIndicator(
                      value: double.parse(event['attendance']!) /
                          double.parse(event['capacity']!),
        ...
        children: [
          ...
          Expanded(
            child: Row(
              ...
              children: [
                _buildBarChart('Mon', 0, 100),
                _buildBarChart('Tue', 0, 100),
      ...
      return Container(
        ...
        child: Column(
          children: [
            ...
            const SizedBox(height: 8),
            Text(
              'Attendance statistics will appear after events take place',
              textAlign: TextAlign.center,
              style: TextStyle(
                fontSize: 14,
                color: Colors.grey[500],
